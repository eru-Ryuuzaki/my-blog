...
![img](https://s0.lgstatic.com/i/image/M00/07/31/Ciqc1F65BNaAd1HlAAFTcrTVgBg517.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160459.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160524.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160546.png)

我们还可以添加一个断点，然后刷新页面，进行单步调试，此时调试过程中使用的就是源代码而不是压缩过后的代码，具体效果如下图所示：

![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160616.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160637.png)
...
![img](https://s0.lgstatic.com/i/image/M00/07/35/Ciqc1F65B2aAGTvVAANPGIkqtEY706.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160755.png)

其实我们可以通过 sourceURL 来声明这段代码所属文件路径，接下来我们再来尝试在执行的 JavaScript 字符串中添加一个 sourceURL 的声明，具体操作如下：

![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160810.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160825.png)

那此时如果我们回到浏览器运行这里的 bundle.js，一旦出现错误，浏览器的控制台就可以定位到具体是哪个模块中的代码，具体效果如下：

![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160841.png)

但是当你点击控制台中的文件名打开这个文件后，看到的却是打包后的模块代码，而并非我们真正的源代码，具体如下：

![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160856.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160916.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160939.png)

然后我们通过 serve 把结果运行起来，打开浏览器，此时我们能够在页面中看到每一个使用不同模式 Source Map 的 HTML 文件，具体如下图：

![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418160954.png)
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418161016.png)

然后我们再来看一个叫作 eval-source-map 的模式，这个模式也是使用 eval 函数执行模块代码，不过这里有所不同的是，eval-source-map 模式除了定位文件，还可以定位具体的行列信息。相比于 eval 模式，它能够生成 Source Map 文件，可以反推出源代码
...
![](https://raw.githubusercontent.com/eru-Ryuuzaki/myPic/master/img/20220418161109.png)
